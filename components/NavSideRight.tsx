...
const NavSideRight = () => {
  ...
  return (
    <aside className='sticky top-0 left-3 h-screen w-[400px] flex flex-col justify-center space-y-5 mr-3'>
      <div className='bg-primary-200 w-full h-[67%] rounded-2xl p-5'>
        ...
        <nav className='flex flex-col justify-between h-[75%] mt-9'>
          <div className='flex flex-col gap-6'>
            <Link className={`text-primary-100 flex space-x-3 text-xs	items-center p-2 pl-4 ${pathName === '/' ? 'bg-[#edb05517]  rounded-2xl' : ''}`} href='/'>
            ...
            <Link className={`text-primary-100 flex space-x-3 text-xs	items-center p-2 pl-4 ${pathName === '/food' ? 'bg-[#edb05517]  rounded-2xl' : ''}`} href='/food'>
            ...
            <Link className={`text-primary-100 flex space-x-3 text-xs	items-center p-2 pl-4 ${pathName === '/drinks' ? 'bg-[#edb05517]  rounded-2xl' : ''}`} href='/drinks'>
          ...
          <div className='flex flex-col gap-6'>
            <Link className={`text-primary-100 flex space-x-3 text-xs	items-center p-2 pl-4 ${pathName === '/service' ? 'bg-[#edb05517]  rounded-2xl' : ''}`} href='/service'>
            ...
            <Link className={`text-primary-100 flex space-x-3 text-xs	items-center p-2 pl-4 ${pathName === '/help' ? 'bg-[#edb05517]  rounded-2xl' : ''}`} href='/help'>
      ...
      <div className='bg-primary-200 w-full h-[27%] rounded-2xl p-5'>
        <div className='flex flex-col h-full justify-around'>
          <div className='flex items-center justify-between'>
            <h3 className='text-primary-100 text-xs'>Cashier</h3>
            <span className='text-primary-100 text-xs'>94 orders</span>
          </div>
          <div className='flex items-center space-x-3 mt-3 rounded-full px-3 py-1 bg-primary-500'>
            <Avatar>
              <AvatarImage src="/assets/avatar2.jpeg" />
              <AvatarFallback>CN</AvatarFallback>
            </Avatar>
            <div>
              <span className='text-primary-100 text-xs font-bold'>Anthony Welc</span>
              <span className='text-primary-400 font-bold block text-[8px]'>Order In Progress...</span>
            </div>
          </div>
